...
import tae3 from './image/tae3.jpg';
...
const URL = "https://teachablemachine.withgoogle.com/models/fQAb69O4b/";
...
class Tae3 extends React.Component{
  ...
  render() {
      ...
      return (
        <Container>
              ...
              <div>
              <img src={tae3} alt="tae3"/>
              </div>
              <h2>태권도 - 얼굴 막기</h2>
              <h3>1. 양 발을 자신의 어깨 넓이보다 조금 더 넓게 벌린 후 무릎을 살짝 굽히며, 양 손을 주먹 쥔 채 자신의 허리 옆으로 가져간다.</h3>
              <h3>2. 오른팔을 하늘을 향해 자신 머리보다 주먹 한 개만큼 위로 빠르게 뻗는다.</h3>
              <h3>3. 뻗은 오른팔을 거두며 왼 팔을 뻗는다.</h3>
