...
const URL = "https://teachablemachine.withgoogle.com/models/mI5_AAoqW/";
...
class Yoga2 extends React.Component{
      ...
      return (
        <Container>
            ...
            <div>
              ...
              <h3>2. 오른발 끝을 90도로 오픈하고 펼친 양팔을 유지하며 오른발을 향해서 서서히 내려간다</h3>
              <h3>3. 시선은 위를 바라보고 척추를 곧게 편 후 20-30초 동안 호흡한다.</h3>
              <h3>4. 다리 힘으로 상체를 일으킨 후 두 발 끝을 교차하여 반대 방향도 실행한다.</h3>
